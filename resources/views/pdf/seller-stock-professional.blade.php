...
{{-- Urutan: berdasarkan stock secara menurun (descending) --}}

<h2 class="section-title">LAPORAN DAFTAR PRODUK BERDASARKAN STOCK</h2>
...
<div class="metadata-section">
    <div class="metadata-grid">
        ...
        <div class="metadata-item">
            <div class="metadata-label">Total Stock</div>
            <div class="metadata-value">{{ $products->sum('stock') }} unit</div>
        </div>
    </div>
</div>
...
<div class="warning-box" style="background:#f0f9ff;border-color:#3b82f6;">
    ...
    <p style="color:#1e40af;">***) Diurutkan berdasarkan stock secara menurun (descending)</p>
</div>
@endsection
