...
<head>
    <meta charset="UTF-8">
    <title>Detail Pengajuan Toko | kampuStore</title>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        /* .active di navbar hanya buat info, ga ngasih garis bawah */
        .nav-menu a.active{
            color:var(--nav-link-color);
        }
    ...
    <div class="admin-container">
        ...
        <section class="admin-main">
            <div class="admin-top-meta">
                <div>
                    <div class="admin-top-left-title">
                        Detail Pengajuan: {{ $seller->nama_toko }}
                    </div>
                    <div class="admin-top-left-sub">
                        Diajukan oleh
                        {{ optional($seller->user)->name ?? $seller->nama_pic }}
                        ({{ $seller->email_pic }})
                    </div>
                </div>
            ...
            <div class="breadcrumb">
                Admin &raquo; Pengajuan Toko &raquo;
                <span class="current">{{ $seller->nama_toko }}</span>
            </div>
            ...
            <section class="panel">
                <header class="panel-header">
                    <div>
                        ...
                        <div class="panel-sub">
                            Informasi utama mengenai toko yang diajukan.
                        </div>
                    </div>
                </header>
            ...
            <section class="panel">
                <header class="panel-header">
                    <div>
                        <div class="panel-title">Data Penanggung Jawab (PIC)</div>
                        <div class="panel-sub">
                            Data pemilik / penanggung jawab toko.
                        </div>
                    </div>
                </header>
            ...
            <section class="panel">
                <header class="panel-header">
                    <div>
                        <div class="panel-title">Alamat PIC</div>
                        <div class="panel-sub">
                            Alamat lengkap domisili penanggung jawab.
                        </div>
                    </div>
                </header>
                ...
                <table class="stats-table">
                    <tr>
                        <th>Alamat</th>
                        <td>{{ $seller->alamat_pic }}</td>
                    </tr>
                    <tr>
                        <th>RT / RW</th>
                        <td>{{ $seller->rt }} / {{ $seller->rw }}</td>
                    </tr>
                    <tr>
                        <th>Kelurahan</th>
                        <td>{{ $seller->kelurahan }}</td>
                    </tr>
                    <tr>
                        <th>Kecamatan</th>
            ...
            <section class="panel">
                <header class="panel-header">
                    <div>
                        <div class="panel-title">Dokumen & Foto</div>
                        <div class="panel-sub">File yang diunggah oleh pengaju.</div>
                    </div>
                </header>
                ...
                <div style="display:flex;gap:24px;align-items:flex-start;">
                    ...
                    <div style="display:flex;flex-direction:column;gap:6px;">
                        <div class="text-muted">Foto KTP</div>
                        <img src="{{ asset('storage/'.$seller->foto_ktp) }}"
                            alt="Foto KTP"
                            style="width:240px;border-radius:12px;border:1px solid #1f2937;">
                    </div>

                    <div style="display:flex;flex-direction:column;gap:6px;">
                        <div class="text-muted">Foto PIC</div>
                    ...
                    <div style="display:flex;flex-direction:column;gap:6px;">
                        <div class="text-muted">File KTP (scan)</div>
                        <a class="btn btn-detail"
                        href="{{ asset('storage/'.$seller->file_ktp_pic) }}"
                        target="_blank">
                            Lihat / Download
                        </a>
                    </div>
            ...
            <section class="panel">
                <header class="panel-header">
                    <div>
                        <div class="panel-title">Aksi Verifikasi</div>
                        <div class="panel-sub">
                            Setujui atau tolak pengajuan ini.
                        </div>
                    </div>
                </header>
                ...
                @else
                    <span class="text-muted">
                        Pengajuan ini sudah berstatus <strong>{{ ucfirst($seller->status) }}</strong>.
                    </span>
                @endif
            </section>
        </section>
...
<script>
    ...
    function confirmApprove(e){
        ...
        Swal.fire({
            title:"Setujui Toko?",
            text:"Toko akan diubah menjadi status APPROVED.",
            icon:"question",
    ...
    function confirmReject(e){
        ...
        Swal.fire({
            ...
            text:"Pengajuan akan diubah menjadi status REJECTED.",
            icon:"warning",
            showCancelButton:true,
